...
public static class OfficialCodexAllowanceReader
{
    ...
    private static async Task<OfficialCodexAllowance?> TryReadAsync(string executable)
    {
        ...
        try
        {
            ...
            await process.StandardInput.WriteLineAsync("{\"method\":\"initialize\",\"id\":1,\"params\":{\"clientInfo\":{\"name\":\"codex-monitor-hud\",\"version\":\"3.2.0\"},\"capabilities\":{\"optOutNotificationMethods\":[\"account/updated\",\"account/rateLimits/updated\"]}}}").ConfigureAwait(false);
