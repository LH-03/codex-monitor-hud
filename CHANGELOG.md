...
- Keep developer static and performance checks in the release workflow, while user installation validates the staged runtime before its transactional switch.
